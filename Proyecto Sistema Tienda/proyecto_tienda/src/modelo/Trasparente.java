...
public class Trasparente extends JLabel implements FocusListener, DocumentListener {
	/**
	 * 
	 */
	...
	public Trasparente(String text, JTextComponent component) {
		this(text, component, Show.ALWAYS);
	}

	public Trasparente(String text, JTextComponent component, Show show) {

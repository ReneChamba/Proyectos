...
public class Transparente extends JLabel implements FocusListener, DocumentListener {
    ...
    public Transparente(String text, JTextComponent component) {
    ...
    public Transparente(String text, JTextComponent component, Show show) {
